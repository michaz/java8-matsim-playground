...
public class PopulationFromSightings {
    ...
    public static void createPopulationWithTwoPlansEach(Scenario scenario, ZoneTracker.LinkToZoneResolver zones, final Sightings sightings) {
    ...
    public static void createPopulationWithEndTimesAtLastSightings(Scenario scenario, ZoneTracker.LinkToZoneResolver zones, final Sightings sightings) {
        for (Entry<Id, List<Sighting>> sightingsPerPerson : sightings.getSightingsPerPerson().entrySet()) {
            Id personId = sightingsPerPerson.getKey();
            List<Sighting> sightingsForThisPerson = sightingsPerPerson.getValue();
            Person person = scenario.getPopulation().getFactory().createPerson(personId);
    ...
    public static void createPopulationWithRandomEndTimesInPermittedWindow(Scenario scenario, ZoneTracker.LinkToZoneResolver zones, final Sightings sightings) {
        for (Entry<Id, List<Sighting>> sightingsPerPerson : sightings.getSightingsPerPerson().entrySet()) {
            Id personId = sightingsPerPerson.getKey();
            List<Sighting> sightingsForThisPerson = sightingsPerPerson.getValue();
            Person person = scenario.getPopulation().getFactory().createPerson(personId);
    ...
    public static void createClonedPopulationWithRandomEndTimesInPermittedWindow(Scenario scenario, ZoneTracker.LinkToZoneResolver zones, final Map<Id, List<Sighting>> sightings, int clonefactor) {
        if (clonefactor < 2)
            return;
    ...
    public static void createPopulationWithRandomRealization(final Scenario scenario, final Sightings sightings, final ZoneTracker.LinkToZoneResolver zones) {
